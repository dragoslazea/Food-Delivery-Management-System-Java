...
/**
 * Clasa pentru implementarea functionalitatilor din interfata IDeliveryServiceProcessing
...
public class DeliveryService extends Observable implements IDeliveryServiceProcessing {
    ...
    /**
     * Comenzile plasate impreuna cu lista produselor din fiecare comanda
     */
    private Map<Order, Collection<MenuItem>> placedOrders;

    /**
     * Multimea utilizatorilor inregistrati
     */
    ...
    /**
     * Getter
     * @return utilizatorii inregistrati
     */
    ...
    /**
     * Adaugare set initial de utilizatori (un administrator si un angajat)
     */
    ...
    /**
     * Cautare utilizator dupa nume de utilizator
     * @param username nume de utilziator
     * @return utilizatorul cu numele de utilizator cautat
     */
    ...
    /**
     * Metoda de tip isWellFormed
     * @return valoare booleana
     */
    public boolean isWellFormed() {
        return (!this.usersSet.isEmpty() && this.usersSet.contains(new User(0, "Administrator 1", "admin1", UserType.ADMINISTRATOR)) && this.usersSet.contains(new User(1, "Employee 1", "employee1", UserType.REGULAR_EMPLOYEE)) && menuItemSet != null && usersSet.size() >= 2);
    }
}
