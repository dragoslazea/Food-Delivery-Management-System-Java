...
public class EmployeeGUI extends JFrame implements Observer {
    ...
    /**
     * Actualizare interfata (suprascrierea metodei din Observer)
     * @param o obiectul Observable
     * @param arg argumentul folosit la actualizare
     */
    @Override
